                    ...
                    <div className="flex-1 overflow-y-auto space-y-12 pr-4 custom-scrollbar">
                        ...
                        <section>
                             ...
                             <div className="space-y-4 text-sm font-mono text-slate-400 border-l-2 border-slate-800 pl-4">
                                 <div>
                                     <div className="text-blue-400 font-bold mb-1">Navigation Precision Fix (2026-01-14)</div>
                                     <p>Fixed navigation drift and overshooting issues. The engine now uses stable coordinate multiplication, and the interface provides higher-precision course data. Verified with comprehensive unit testing for long-distance and diagonal travel.</p>
                                 </div>
                                 <div>
